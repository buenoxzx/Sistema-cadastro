import { z } from 'zod';
import { insertClientSchema, insertDocumentSchema, clients, documents } from './schema';
...
export const api = {
  clients: {
    ...
    get: {
      ...
      path: '/api/clients/:id',
      responses: {
        200: z.custom<typeof clients.$inferSelect & { documents: typeof documents.$inferSelect[] }>(),
